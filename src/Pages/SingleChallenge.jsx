...
<div className="single-station">
      ...
      <button className="submit" disabled={answeredMsg === "Correct answer! Station completed." ? true : false} onClick={() => handleSubmitAnswer(station.id)}>Submit</button>
      <p>{answeredMsg}</p>

</div>
    <div className="back-button-container">

      <Link to={"/challenges"}><button className="back-to-stations">Back to stations</button></Link>
    </div>
